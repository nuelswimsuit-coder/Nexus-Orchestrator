...
from nexus.services.trading_bot import MASTER_STRIKE_MIN_CONFIDENCE_PCT
...
from nexus.agents.tasks.prediction import BINANCE_VELOCITY_KEY
...
def master_strike_eligible(
    ...
    *,
    ...
    return (
        confidence >= MASTER_STRIKE_MIN_CONFIDENCE_PCT
        and swarm_agents >= 4
        and news_score >= 9.0
