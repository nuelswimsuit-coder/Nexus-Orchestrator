...
const translations = {
  ...
  niche_lab:   { en: "Niche Lab",   he: "מעבדת נישים" },
  settings:    { en: "Settings",    he: "הגדרות" },
  about:       { en: "About",       he: "אודות" },
  modules:          { en: "Modules",          he: "מודולים" },
  sessions:         { en: "Telegram sessions", he: "סשני טלגרם" },
  wallet_ops:       { en: "Wallet Ops",       he: "פעולות ארנק" },
  swarm_control:    { en: "Swarm Control",    he: "שליטת נחיל" },
  swarm_commander:  { en: "Swarm Commander",  he: "מפקד נחיל" },
  sentinel_seo:       { en: "Sentinel SEO",     he: "סנטינל SEO" },
  ...
  session_commander: { en: "Telegram session Cmd", he: "מפקד סשני טלגרם" },
  ...
  nav_desc_incubator:         { en: "Group nurture & member stats", he: "טיפוח קבוצות וסטטיסטיקות" },
  nav_desc_niche_lab: {
    en: "AI birth protocol & project eggs (legacy hub)",
    he: "פרוטוקול לידה AI וביצי פרויקט",
  },
  nav_desc_settings:          { en: "Configuration",        he: "תצורה" },
  nav_desc_about:             { en: "v2.0-Alpha",           he: "v2.0-Alpha" },
  nav_desc_sessions:          { en: "Telegram session vault", he: "ניהול סשני טלגרם" },
  nav_desc_wallet_ops:        { en: "Polymarket & PnL",     he: "פוליימרקט ורווח" },
  nav_desc_swarm_control:     { en: "Group Warmer",         he: "חימום קבוצות" },
  swarm_commander_desc: {
    en: "Enqueue Telethon health scan for staged Telegram accounts (writes management DB).",
    he: "הוספת סריקת בריאות Telethon לחשבונות טלגרם (כותב ל-DB ניהול).",
  },
  community_factory_title: { en: "Community Factory", he: "מפעל קהילות" },
  community_factory_desc: {
    en: "Monitor groups, Telegram (Telethon) sessions, messages, and flood/ban rates. Start queues bootstrap on the worker.",
    he: "ניטור קבוצות, סשני טלגרם (Telethon), הודעות ושיעור Flood/חסימות. התחלה שולחת משימת bootstrap לוורקר.",
  },
  community_factory_start: { en: "Start factory pipeline", he: "התחל צינור מפעל" },
  community_factory_phase: { en: "Phase", he: "שלב" },
  community_factory_groups: { en: "Total groups", he: "סה״כ קבוצות" },
  community_factory_sessions: { en: "Active Telegram sessions", he: "סשני טלגרם פעילים" },
  community_factory_messages: { en: "Messages sent", he: "הודעות נשלחו" },
  community_factory_error_rate: { en: "Error rate (floods+bans)/attempts", he: "שיעור שגיאות" },
  community_factory_floods: { en: "Flood waits", he: "המתנות Flood" },
  community_factory_bans: { en: "Bans", he: "חסימות" },
  nav_desc_sentinel_seo: {
    en: "Search rank & shadowban heuristics",
    he: "דירוג חיפוש והיוריסטיקת צל",
  },
  management_run_health_scan: { en: "Run group health scan", he: "הרץ סריקת בריאות קבוצות" },
  management_run_sentinel_seo: { en: "Run Sentinel SEO scan", he: "הרץ סריקת Sentinel SEO" },
  management_col_session: { en: "Telegram session", he: "סשן טלגרם" },
  management_col_title: { en: "Title", he: "כותרת" },
  management_col_members: { en: "Members", he: "חברים" },
  management_col_active: { en: "Active est.", he: "פעילים (הערכה)" },
  management_no_groups: {
    en: "No groups in management DB yet. Run a health scan from Swarm Control.",
    he: "אין קבוצות ב-DB ניהול. הרץ סריקה מבקרת הנחיל.",
  },
  management_no_ranks: {
    en: "No rank data yet. Run Sentinel SEO (optionally add 2+ word phrases).",
    he: "אין נתוני דירוג. הרץ Sentinel SEO.",
  },
  management_seo_phrases_label: {
    en: "Extra keyword phrases (comma-separated, each 2+ words)",
    he: "ביטויי מפתח נוספים (מופרדים בפסיק, לפחות 2 מילים)",
  },
  management_phrase_two_words: {
    en: "Each phrase must contain at least two words.",
    he: "כל ביטוי חייב להכיל לפחות שתי מילים.",
  },
  management_rank_table: { en: "Rank tracker", he: "מעקב דירוג" },
  ...
  nav_desc_session_commander: { en: "Telegram session health", he: "בריאות סשני טלגרם" },
  ...
  nav_desc_bot_factory:       { en: "Telegram session generator", he: "יצרן סשני טלגרם" },
  ...
  // ── Telegram session / fleet metrics (not Redis) ─────────────────────────
  active_sessions:   { en: "Active Telegram sessions", he: "סשני טלגרם פעילים" },
  total_sessions:    { en: "Total Telegram sessions",  he: "סה\"כ סשני טלגרם" },
  cost_per_session:  { en: "Cost / Telegram session",  he: "עלות / סשן טלגרם" },
  fuel_level:        { en: "Fuel Level",      he: "רמת דלק" },
  session_fuel:      { en: "Telegram session fuel",    he: "דלק סשן טלגרם" },
