...
const translations = {
  ...
  swarm_commander_desc: {
    en: "Enqueue Telethon health scan for staged sessions (writes management DB).",
    he: "הוספת סריקת בריאות Telethon לסשנים (כותב ל-DB ניהול).",
  },
  community_factory_title: { en: "Community Factory", he: "מפעל קהילות" },
  community_factory_desc: {
    en: "Monitor groups, sessions, messages, and flood/ban rates. Start queues bootstrap on the worker.",
    he: "ניטור קבוצות, סשנים, הודעות ושיעור Flood/חסימות. התחלה שולחת משימת bootstrap לוורקר.",
  },
  ...
  community_factory_sessions: { en: "Active sessions", he: "סשנים פעילים" },
  ...
  management_col_session: { en: "Session", he: "סשן" },
