"""Upload fixed files and restart worker."""
import paramiko
import time
import sys
import io
...
sftp.put(
    'C:/Users/Yarin/Desktop/Nexus-Orchestrator/nexus/worker/listener.py',
    '/home/yadmin/Desktop/Nexus-Orchestrator/nexus/worker/listener.py'
)
sftp.close()
print('Uploaded start_worker.py and listener.py')
...
print('=== Heartbeat in Redis ===')
stdin, stdout, stderr = ssh.exec_command('redis-cli -h 10.100.102.8 -p 6379 keys nexus:heartbeat:*')
print(stdout.read().decode().strip())
